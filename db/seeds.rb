...
Player.destroy_all
a1 = Player.create :first_name => 'LeBron', :last_name => 'James', :number => 23
a2 = Player.create :first_name => 'James', :last_name => 'Harden', :number => 13
a3 = Player.create :first_name => 'Stephen', :last_name => 'Curry', :number => 30
